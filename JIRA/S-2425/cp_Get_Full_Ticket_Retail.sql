...
/****** Object:  StoredProcedure [dbo].[cp_Get_Full_Ticket_Retail]    Script Date: 5/11/2021 2:21:49 PM ******/
SET ANSI_NULLS ON
GO
...
item_quantity                     AS quantity, 
			 ...
			 (CS.forename+' '+CS.surname)      AS nameOfHolder,
      ...
      FROM   @BasketItems AS BI 
			 ...
			 LEFT JOIN dbo.tbl_item_consumer IC            -- This portion is added for SMAREP-2425
				ON IC.sale_item_id = BI.basketitemid       -- "
...
sale_id                INT NOT NULL, 
 ...
 END 
      ...
      SELECT @OutBoundJourneySideFare = outboundjourneysidefare, 
  @InBoundJourneySideFare = Isnull(inboundjourneysidefare, 0) 
      FROM   dbo.tbl_journey_side_fares 
      WHERE  sale_id = @SaleID 
