...
/****** Object:  StoredProcedure [dbo].[cp_Get_Full_Ticket_Retail]    Script Date: 1/12/2022 7:16:53 AM ******/
SET ANSI_NULLS ON
GO
...
-- Description	:  SMAREP-3601 : LIVE: TC shows incorrect number of passengers on the ticket - EULUT270
-- Sample Script:  exec cp_Get_Full_Ticket_Retail 'C7V11333'
-- ============================================================================================
...
AS 
  BEGIN 
      ...
      SELECT DISTINCT b.sale_id, 
                      ...
                      A.agent_id, 
                      (SELECT name 
                       FROM   [NXNHASQLSRV1].[ams].[dbo].[tb_agent]
	...
	END
     ...
     ON SI.sales_item_id = SIT.sales_item_id 
      ...
      FROM   @baskets B 
             ...
             LEFT JOIN [UKPSQ03].netplans.dbo.tb_tick_typ 
  ...
  AND SI.sale_id = @saleid 
      ...
      FROM   tbl_item_consumer IC 
             INNER JOIN tbl_consumers C 
					 ...
					 AND C.consumer_id NOT IN ( 0, 1, 2, 3, 4, 5, 5445592, 5445601, 5445609)   -- SMAREP-3106
