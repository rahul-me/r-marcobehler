...
/****** Object:  StoredProcedure [dbo].[cp_RetailAPI_Basket_Reservation]    Script Date: 7/28/2021 10:06:42 AM ******/
SET ANSI_NULLS ON
GO
...
-- Description	:	Created procedure to record new reservation details (Used in Mercury)
-- ==================================================================================================================
-- Author		:	Urvashi Parmar
-- Modified date:	22-Sept-2020
-- Description	:	SMAREP-1739 : Altered stored procedure to store applied discount from mercury into tbl_Discounts_Applied table
-- ==================================================================================================================
-- Author		:	Kajal Patel
-- Modified date:	06-Nov-2020
-- Description	:	SMAREP-1836 : Hardcoded TravelCAT SalesChannelCode for contactcenter to identify transactions done by TravelCAT application.
-- ==================================================================================================================
-- Author		:	Kajal Patel
-- Modified date:	09-Nov-2020
-- Description	:	SMAREP-1926 : removed case for coachcard type. 
-- ==================================================================================================================
-- Author		:	Rahul Chauhan
-- Modified date:	28-July-2020
-- Description	:	SMAREP-2785 : Added insertion of country code to tbl_Phone_Contacts_Country_Code table
-- ==================================================================================================================

-- Sample Execution Script	:	 
-- EXEC cp_RetailAPI_Basket_Reservation  @TicketXML='<Ticket agentCode="D085" agentUser="uparmar" journeyType="R" salesChannel="Call" ticketNumber="U2000995"><Addons><Addon><Item_quantity>1</Item_quantity><Item_value>250</Item_value><new_fare>0</new_fare><old_fare>0</old_fare><SKU>B02B002</SKU></Addon><Addon><Item_quantity>1</Item_quantity><Item_value>100</Item_value><new_fare>0</new_fare><old_fare>0</old_fare><SKU>H42H241</SKU></Addon></Addons><Discounts><Discount campaignCode="DEFAULT" campaignID="684" discountCode="ND-TRAVELCAT" productSKU ="H01H001" value="3150"/></Discounts><DistributionDetails distributionType="M Ticket" email=""/><Fare inBoundJourneySideFare="1575" netPrice="3150" NewFare="0" oldFare="0" outBoundJourneySideFare="1575" type="CFL"/><LeadPassenger emailConsent="true" fir st Name="test" surname="test" telephone="563336" telephoneConsent="false" title="Miss"><Address><Address1>1, Beverley Hills Park</Address1><Address2>Boscombe Down</Address2><Address3>Amesbury</Address3><AddressTypeID>0</AddressTypeID><PostCode>SP47LH</Post Co de><Town>Salisbury</Town></Address></LeadPassenger><Legs><Leg><actual_fare_value>0</actual_fare_value><arr_date>1601424000</arr_date><arr_date_string>2020-09-30 05:35:00</arr_date_string><arr_day>0</arr_day><arr_time>335</arr_time><check_in_time>180</ch ec k_in_time><company_brand_id>NX</company_brand_id><coupon_fare_value>0</coupon_fare_value><dept_date>1601424000</dept_date><dept_date_string>2020-09-30 03:00:00</dept_date_string><dept_time>180</dept_time><displacement_days>1</displacement_days><fare_typ e> CFL</fare_type><flight_code>AF</flight_code><flight_start_time>2335</flight_start_time><from_loc>33023</from_loc><from_stop>A</from_stop><gd_trigger_level>0</gd_trigger_level><leg_dir>O</leg_dir><leg_no>0</leg_no><serv_dir>I</serv_dir><serv_nr>423</serv _n r><to_loc>57286</to_loc><to_stop>A</to_stop></Leg><Leg><actual_fare_value>0</actual_fare_value><arr_date>1601424000</arr_date><arr_date_string>2020-09-30 08:20:00</arr_date_string><arr_day>0</arr_day><arr_time>500</arr_time><check_in_time>410</check_in_ ti me><company_brand_id>NX</company_brand_id><coupon_fare_value>0</coupon_fare_value><dept_date>1601424000</dept_date><dept_date_string>2020-09-30 06:50:00</dept_date_string><dept_time>410</dept_time><displacement_days>0</displacement_days><fare_type>CFL</ fa re_type><flight_code>AA</flight_code><flight_start_time>0415</flight_start_time><from_loc>57286</from_loc><from_stop>A</from_stop><gd_trigger_level>0</gd_trigger_level><leg_dir>O</leg_dir><leg_no>1</leg_no><serv_dir>I</serv_dir><serv_nr>444</serv_nr><to _l oc>57366</to_loc><to_stop>L</to_stop></Leg><Leg><actual_fare_value>0</actual_fare_value><arr_date>1601510400</arr_date><arr_date_string>2020-10-01 02:50:00</arr_date_string><arr_day>1</arr_day><arr_time>170</arr_time><check_in_time>1410</check_in_time>< co mpany_brand_id>NX</company_brand_id><coupon_fare_value>0</coupon_fare_value><dept_date>1601424000</dept_date><dept_date_string>2020-09-30 23:30:00</dept_date_string><dept_time>1410</dept_time><displacement_days>0</displacement_days><fare_type>CFL</fare_ ty pe><flight_code>NA</flight_code><flight_start_time>2330</flight_start_time><from_loc>57366</from_loc><from_stop>A</from_stop><gd_trigger_level>0</gd_trigger_level><leg_dir>I</leg_dir><leg_no>2</leg_no><serv_dir>O</serv_dir><serv_nr>422</serv_nr><to_loc> 33 023</to_loc><to_stop>A</to_stop></Leg></Legs><Passengers><Passenger type="AD"/></Passengers><Payment payment_type="Card" payment_value="3500"><BillingAddress><address1>1, Beverley Hills Park</address1><address2>Boscombe Down</address2><address3>Amesbury </ address3><addressTypeId>0</addressTypeId><postcode>SP47LH</postcode><town>Salisbury</town></BillingAddress><CardPayment card_type="visa" payment_provider="Barclays" payment_provider_transaction_id="8816007564867904"/></Payment></Ticket>'
-- ==================================================================================================================

ALTER PROCEDURE [dbo].[cp_RetailAPI_Basket_Reservation]
(
	 @TicketXML ntext
	,@SaleID Int output
...
-- assign defualt journeyside fare if null from input
...
INSERT INTO [dbo].[tbl_Journey_Side_Fares]
           ...
           ,[Sale_ID])
     VALUES
           (ISNULL(@OutBoundJourneySideFare , 0) 
...
if @@error <> 0
	...
	select @JourneyTypeID = ticket_journey_type_id from tbl_Ticket_Journey_Types where  ticket_journey_type_code = @JrnyType
 --add journey type

EXECUTE @RC =   [dbo].[cp_Add_Ticket_Journey_Type]
   @ticket
  ,@JourneyTypeID
  ,@sale_id
...
if @@error <> 0
	begin
		--print 'error5'
		EXEC sp_xml_removedocument @docHandle
		SET @Message = 'Failed to create sale item transaction for transaction ID 2'
	    RAISERROR('Failed to create sale item transaction for transaction id 2',11,1)
		GOTO ErrorDetetcted
	end
...
declare @countryCode varchar(5)                           -- Rahul C. SMAREP-2785: Added countryCode
declare @LeadPaxPostOutConsent bit
declare @LeadPaxEmailConsent bit
declare @LeadPaxTelephoneConsent bit
declare @PhoneContactId int                               -- Rahul C. SMAREP-2785: Declared variable for saving phone contact id.
	...
	select
		...
		,@countryCode = countryCode                       -- Rahul C. SMAREP-2785: Taking country code from XML
	...
	WITH ( 
			...
			countryCode     varchar(5) '@countryCode',     -- Rahul C. SMAREP-2785: Taking country code from XML          
	...
	----		 Add telephone
			...
			if not @LeadPaxTelephone is NULL
				Begin
					...
					-- Rahul C. SMAREP-2785 START 		
					set @PhoneContactId = SCOPE_IDENTITY()

					IF ISNULL(@countryCode, '') <> ''
						BEGIN
							INSERT into [dbo].[tbl_Phone_Contacts_Country_Code]
							( 
							phone_contacts_id,
							country_code
							)
...
INSERT INTO [dbo].[Logs]
     ...
     VALUES
           ('Retail API - @TicketDistributionType'           
           ,getdate()         
           ,@TicketDistributionType
           )
...
INSERT INTO [dbo].[Logs]
     ...
     VALUES
           ('Retail API - @Distribution_Type_ID'           
           ,getdate()         
...
-- SMAREP-1926 : removed case for type because XML contains type value.
-- Add Coachcards
...
-- (1) Basket summary
	   ...
	   if @highestFarePaidSoFar > @Farevalue * 100
			BEGIN
     ...
     SELECT
		...
		if @errorCheck <> 0
			begin
				EXEC sp_xml_removedocument @docHandle
				SET @Message = 'Failed to insert record into basket summary table'
					RAISERROR('Failed to insert record into basket summary table',11,1)
					GOTO ErrorDetetcted
			end
--(2) Journey Summary
		...
		if @errorCheck <> 0
			begin
				EXEC sp_xml_removedocument @docHandle
				SET @Message = 'Failed to insert record into journey summary table'
					RAISERROR('Failed to insert record into journey summary table',11,1)
					GOTO ErrorDetetcted
			end
...
--(4) Misc Info
    ...
    Set @errorCheck = @@error
		if @errorCheck <> 0
			begin
				EXEC sp_xml_removedocument @docHandle
				SET @Message = 'Failed to insert record into misc basket info'
					RAISERROR('Failed to insert record into misc basket info',11,1)
					GOTO ErrorDetetcted
			end       
...
select @RESULT = 1
select @Message = 'Ticket Added Successfully'
EXEC sp_xml_removedocument @docHandle
COMMIT TRAN
GOTO Ending
